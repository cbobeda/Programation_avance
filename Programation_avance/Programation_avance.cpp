...
Image dessine(int dx,int dy,int size,Color couleur,Texture texture)
{
...
Texture changeColor(Texture texture)
{
    if (Mouse::isButtonPressed(Mouse::Left))
    {
        ...
        {
            texture.update(dessine(Mouse::getPosition().x,Mouse::getPosition().y,Drawsize,colorTab[currentColor],texture));
        }
    }
    return texture;
}
